...
wget https://raw.githubusercontent.com/ffontinele35/SSHPLUS-MANAGER-FREE/master/Install/lista > /dev/null 2>&1
wget https://raw.githubusercontent.com/ffontinele35/SSHPLUS-MANAGER-FREE/master/versao -O /bin/versao > /dev/null 2>&1
wget https://raw.githubusercontent.com/ffontinele35/SSHPLUS-MANAGER-FREE/master/Install/licence -O /usr/lib/licence > /dev/null 2>&1
clear
